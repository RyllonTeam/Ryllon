...
io.popen("mkdir itR_Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls itR_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
function DevBot(msg) 
local hash = database:sismember(bot_id.."itR:Sudo:User", msg.sender_user_id_) 
if hash or Bot(msg) or DevitR(msg) or VIP_DeV(msg) then    
return true  
else  
return false  
end  
...
local hash = database:sismember(bot_id.."itR:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or Bot(msg) or DevitR(msg) or DevBot(msg) or VIP_DeV(msg) then     
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."itR:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or Bot(msg) or DevitR(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
function Owner(msg)
local hash = database:sismember(bot_id.."itR:Manager"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevitR(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."itR:Mod:User"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevitR(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."itR:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevitR(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
...
function Vips(msg)
local hash = database:sismember(bot_id.."itR:Special:User"..msg.chat_id_,msg.sender_user_id_) 
if hash or Bot(msg) or  DevitR(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) then        
return true 
else 
return false 
end 
end
function CleangGroups();local z = io.open('./itR');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/itR.lua)(.*)$") then;os.execute('chmod +x install.sh');os.execute('./install.sh get');end;end
function General_ban(user_id,chat_id)
if DevitRe(user_id) == true then
var = true
elseif DevitR(user_id) == true then
var = true
...
var = true  
elseif database:sismember(bot_id.."itR:Sudo:User", user_id) then
var = true  
elseif database:sismember(bot_id.."itR:Basic:Constructor"..chat_id, user_id) then
var = true                 
elseif database:sismember(bot_id.."itR:Basic:Constructor"..chat_id, user_id) then
var = true
elseif database:sismember(bot_id.."itR:Constructor"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."itR:Manager"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."itR:Mod:User"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."itR:Special:User"..chat_id, user_id) then  
var = true  
else  
var = false  
end  
...
elseif tonumber(user_id) == tonumber(1788708761) then  
var = "مبرمج السورس"  
elseif DevitRe(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then  var = "المطور الاساسي²"  
elseif database:sismember(bot_id.."itR:Sudo:User", user_id) then
var = database:get(bot_id.."itR:Sudo:Rd"..chat_id) or "المطور"  
elseif database:sismember(bot_id.."itR:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."itR:BasicConstructor:Rd"..chat_id) or "المنشئ اساسي"
elseif database:sismember(bot_id.."itR:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."itR:Constructor:Rd"..chat_id) or "المنشئ"  
elseif database:sismember(bot_id.."itR:Manager"..chat_id, user_id) then
var = database:get(bot_id.."itR:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."itR:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."itR:Mod:Rd"..chat_id) or "الادمن"  
elseif database:sismember(bot_id.."itR:MN:TF"..chat_id, user_id) then
var =  "منظف"  
elseif database:sismember(bot_id.."itR:Special:User"..chat_id, user_id) then  
var = database:get(bot_id.."itR:Special:Rd"..chat_id) or "المميز"  
else  
var = database:get(bot_id.."itR:Memp:Rd"..chat_id) or "العضو"
end  
return var
end 
function ChekAdd(chat_id)
if database:sismember(bot_id.."itR:Chek:Groups",chat_id) then
var = true
else 
var = false
end
...
if database:sismember(bot_id.."itR:Muted:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."itR:Ban:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."itR:GBan:User",User_id) then
Var = true
else
Var = false
end
...
database:sadd(bot_id..'itR:Chek:Groups',idg) 
database:set(bot_id.."itR:Lock:tagservrbot"..idg,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'itR:'..lock..idg,"del")    
end
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd(bot_id.."itR:Constructor"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd(bot_id.."itR:Manager"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd(bot_id.."itR:Mod:User"..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd(bot_id.."itR:Basic:Constructor"..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
...
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_) 
...
function itR_Files(msg)
for v in io.popen('ls itR_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("itR_Files/"..v)
if plugin.itR and msg then
pre_msg = plugin.itR(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function itR_Started_Bot(msg,data) -- بداية العمل
if msg then
...
database:incr(bot_id..'itR:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
database:sadd(bot_id..'itR:UsersBot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
end
if database:get(bot_id.."itR:itR:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء•" then   
send(msg.chat_id_, msg.id_,"• تم الغاء الاذاعه") 
database:del(bot_id.."itR:itR:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."itR:Chek:Groups") 
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
database:set(bot_id..'itR:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
database:set(bot_id..'itR:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
database:set(bot_id..'itR:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
database:set(bot_id..'itR:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."itR:flooding:settings:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."itR:flooding:settings:"..msg.chat_id_,"flood") or "nil"
Num_Msg_Max = database:hget(bot_id.."itR:flooding:settings:"..msg.chat_id_,"floodmax") or 5
Time_Spam = database:hget(bot_id.."itR:flooding:settings:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id.."itR:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."itR:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."itR:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."itR:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."itR:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if database:hget(bot_id.."itR:flooding:settings:"..msg.chat_id_,"floodmax") then
Num_Msg_Max = database:hget(bot_id.."itR:flooding:settings:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."itR:flooding:settings:"..msg.chat_id_,"floodtime") then
Time_Spam = database:hget(bot_id.."itR:flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."itR:Lock:text"..msg.chat_id_) and not Vips(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
database:incr(bot_id.."itR:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if database:get(bot_id.."itR:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if database:get(bot_id.."itR:Lock:Join"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if database:get(bot_id.."itR:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."itR:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if database:get(bot_id.."itR:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."itR:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."itR:Lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Photo"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Photo"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."itR:Lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Video"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Video"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."itR:Lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Animation"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Animation"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."itR:Lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:geam"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:geam"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."itR:Lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Audio"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Audio"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."itR:Lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:vico"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:vico"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."itR:Lock:Keyboard"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Keyboard"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Keyboard"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."itR:Lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Sticker"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Sticker"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."itR:Lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."itR:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."itR:Lock:forward"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."itR:Lock:forward"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if database:get(bot_id.."itR:Lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Document"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Document"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."itR:Lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Unsupported"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Unsupported"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if database:get(bot_id.."itR:Lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Markdaun"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Markdaun"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if database:get(bot_id.."itR:Lock:Inlen"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Inlen"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Inlen"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if database:get(bot_id.."itR:Lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Contact"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Contact"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if database:get(bot_id.."itR:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."itR:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
--------------------------------------------------------------------------------------------------------------
local status_welcome = database:get(bot_id.."itR:Chek:Welcome"..msg.chat_id_)
if status_welcome and not database:get(bot_id.."itR:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = database:get(bot_id.."itR:Get:Welcome:Group"..msg.chat_id_)  
...
database:set(bot_id.."itR:Pin:Id:Msg"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = database:get(bot_id.."itR:Pin:Id:Msg"..msg.chat_id_)
if Msg_Pin and database:get(bot_id.."itR:lockpin"..msg.chat_id_) then
...
if database:get(bot_id.."itR:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
database:del(bot_id.."itR:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."itR:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"• تم الغاء وضع الوصف") 
database:del(bot_id.."itR:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."itR:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."itR:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"• تم الغاء حفظ الترحيب") 
database:del(bot_id.."itR:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."itR:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id.."itR:Get:Welcome:Group"..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"• تم حفظ ترحيب المجموعه")   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."itR:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"• تم الغاء حفظ الرابط")       
database:del(bot_id.."itR:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
...
if database:get(bot_id.."itR:itR:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء•" then   
send(msg.chat_id_, msg.id_,"• تم الغاء الاذاعه للخاص") 
database:del(bot_id.."itR:itR:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id..'itR:UsersBot')  
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
end
...
if database:get(bot_id.."itR:itR:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء•" then   
send(msg.chat_id_, msg.id_,"• تم الغاء الاذاعه") 
database:del(bot_id.."itR:itR:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."itR:Chek:Groups") 
if msg.content_.text_ then
...
if database:get(bot_id.."itR:itR:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء•" then   
send(msg.chat_id_, msg.id_,"• تم الغاء الاذاعه") 
database:del(bot_id.."itR:itR:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
...
if database:get(bot_id.."itR:itR:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء•" then   
send(msg.chat_id_, msg.id_,"• تم الغاء الاذاعه") 
database:del(bot_id.."itR:itR:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = database:smembers(bot_id.."itR:UsersBot")   
...
local itR_Msg = database:sismember(bot_id.."itR:List:Filter:text"..msg.chat_id_,text) 
if itR_Msg then    
...
if msg.content_.ID == 'MessageAnimation' and not Vips(msg) then      
local geAni = database:sismember(bot_id.."itR:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_) 
if geAni then        
...
if msg.content_.ID == 'MessageSticker' and not Vips(msg) then      
local ker = database:sismember(bot_id.."itR:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_) 
if ker then        
...
if msg.content_.ID == 'MessagePhoto' and not Vips(msg) then      
local phh = database:sismember(bot_id.."itR:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_) 
if phh then        
...
if database:get(bot_id.."itR:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء•" then   
send(msg.chat_id_, msg.id_,"• تم الغاء حفظ اسم البوت") 
database:del(bot_id.."itR:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."itR:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."itR:Name:Bot",text) 
send(msg.chat_id_, msg.id_, "• تم حفظ اسم البوت")  
return false
end 
if text and database:get(bot_id.."itR:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
database:set(bot_id.."itR:Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"• ارسل الامر الجديد")  
database:del(bot_id.."itR:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
database:set(bot_id.."itR:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and database:get(bot_id.."itR:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = database:get(bot_id.."itR:Set:Cmd:Group:New"..msg.chat_id_)
database:set(bot_id.."itR:Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
database:sadd(bot_id.."itR:List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"• تم حفظ الامر")  
database:del(bot_id.."itR:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
database:set(bot_id.."itR:Lock:text"..msg.chat_id_,true) 
...
database:set(bot_id.."itR:Lock:AddMempar"..msg.chat_id_,"kick")  
...
database:set(bot_id.."itR:Lock:Join"..msg.chat_id_,"kick")  
...
database:set(bot_id.."itR:Lock:Bot:kick"..msg.chat_id_,"del")  
...
database:set(bot_id.."itR:Lock:Bot:kick"..msg.chat_id_,"kick")  
...
database:set(bot_id.."itR:Lock:tagservr"..msg.chat_id_,true)  
...
database:set(bot_id.."itR:lockpin"..msg.chat_id_, true) 
database:sadd(bot_id.."itR:Lock:pin",msg.chat_id_) 
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  database:set(bot_id.."itR:Pin:Id:Msg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
...
database:set(bot_id.."itR:Lock:edit"..msg.chat_id_,true) 
...
database:set(bot_id.."itR:Lock:tagservrbot"..msg.chat_id_,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'itR:'..lock..msg.chat_id_,"del")    
end
...
database:del(bot_id.."itR:Lock:AddMempar"..msg.chat_id_)  
...
database:del(bot_id.."itR:Lock:text"..msg.chat_id_)  
...
database:del(bot_id.."itR:Lock:Join"..msg.chat_id_)  
...
database:del(bot_id.."itR:Lock:Bot:kick"..msg.chat_id_)  
...
database:del(bot_id.."itR:Lock:tagservr"..msg.chat_id_)  
...
database:del(bot_id.."itR:lockpin"..msg.chat_id_)  
database:srem(bot_id.."itR:Lock:pin",msg.chat_id_)
...
database:del(bot_id.."itR:Lock:edit"..msg.chat_id_) 
...
database:del(bot_id.."itR:Lock:tagservrbot"..msg.chat_id_)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:del(bot_id..'itR:'..lock..msg.chat_id_)    
end
...
database:del(bot_id.."itR:Lock:Link"..msg.chat_id_)  
...
database:del(bot_id.."itR:Lock:User:Name"..msg.chat_id_)  
...
database:del(bot_id.."itR:Lock:Animation"..msg.chat_id_)  
...
database:del(bot_id.."itR:Lock:Sticker"..msg.chat_id_)  
...
database:hset(bot_id.."itR:flooding:settings:"..msg.chat_id_ ,"flood","kick")  
...
database:hset(bot_id.."itR:flooding:settings:"..msg.chat_id_ ,"flood","del")  
...
database:hset(bot_id.."itR:flooding:settings:"..msg.chat_id_ ,"flood","keed")  
...
database:hset(bot_id.."itR:flooding:settings:"..msg.chat_id_ ,"flood","mute")  
...
database:hdel(bot_id.."itR:flooding:settings:"..msg.chat_id_ ,"flood")  
...
function Function_itR(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_itR, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_itR, nil)
return false 
end
...
if text == ("الثانويين") and DevitR(msg) then
local list = database:smembers(bot_id.."DEV:Sudo:T")
t = "\n• قائمة مطورين الثانويين للبوت \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."itR:User:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
else
t = t..""..k.."- (`"..v.."`)\n"
...
if text == ("مسح قائمه العام") and DevitR(msg) then
database:del(bot_id.."itR:GBan:User")
send(msg.chat_id_, msg.id_, "\n• تم مسح قائمه العام")
return false
end
if text == ("مسح المطورين") and DevitR(msg) then
database:del(bot_id.."itR:Sudo:User")
send(msg.chat_id_, msg.id_, "\n• تم مسح قائمة المطورين  ")
end
if text == "مسح المنشئين الاساسين" and DevBot(msg) then
database:del(bot_id.."itR:Basic:Constructor"..msg.chat_id_)
...
database:del(bot_id.."itR:Constructor"..msg.chat_id_)
...
database:del(bot_id.."itR:Manager"..msg.chat_id_)
...
database:del(bot_id.."itR:Mod:User"..msg.chat_id_)
...
database:del(bot_id.."itR:Special:User"..msg.chat_id_)
...
database:del(bot_id.."itR:Muted:User"..msg.chat_id_)
...
database:del(bot_id.."itR:Ban:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "\n• تم مسح المحظورين")
end
if text == ("قائمه العام") and DevitR(msg) then
local list = database:smembers(bot_id.."itR:GBan:User")
t = "\n• قائمة المحظورين عام \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."itR:User:Name" .. v)
if username then
...
if text == ("المطورين") and DevitR(msg) then
local list = database:smembers(bot_id.."itR:Sudo:User")
t = "\n• قائمة مطورين البوت \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."itR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."itR:Basic:Constructor"..msg.chat_id_)
...
local list = database:smembers(bot_id.."itR:Constructor"..msg.chat_id_)
t = "\n• قائمة المنشئين \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."itR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."itR:Manager"..msg.chat_id_)
t = "\n• قائمة المدراء \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."itR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."itR:Mod:User"..msg.chat_id_)
t = "\n• قائمة الادمنيه \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."itR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."itR:Special:User"..msg.chat_id_)
...
local list = database:smembers(bot_id.."itR:Muted:User"..msg.chat_id_)
t = "\n• قائمة المكتومين \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."itR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."itR:Ban:User"..msg.chat_id_)
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevitR(msg) then
function Function_itR(extra, result, success)
...
database:sadd(bot_id.."itR:GBan:User", result.sender_user_id_)
...
if text and text:match("^حظر عام @(.*)$")  and DevitR(msg) then
...
database:sadd(bot_id.."itR:GBan:User", result.id_)
...
if text and text:match("^حظر عام (%d+)$") and DevitR(msg) then
...
database:sadd(bot_id.."itR:GBan:User", userid)
Reply_Status(msg,userid,"reply","• تم حظره عام من المجموعات")  
return false
end
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevitR(msg) then
function Function_itR(extra, result, success)
database:srem(bot_id.."itR:GBan:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","• تم الغاء حظره عام من المجموعات")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_itR, nil)
return false
end
if text and text:match("^الغاء العام @(.*)$") and DevitR(msg) then
local username = text:match("^الغاء العام @(.*)$") 
function Function_itR(extra, result, success)
if result.id_ then
Reply_Status(msg,result.id_,"reply","• تم الغاء حظره عام من المجموعات")  
database:srem(bot_id.."itR:GBan:User", result.id_)
else
send(msg.chat_id_, msg.id_,"• لا يوجد حساب بهاذا المعرف")
end
end
...
if text and text:match("^الغاء العام (%d+)$") and DevitR(msg) then
local userid = text:match("^الغاء العام (%d+)$")
database:srem(bot_id.."itR:GBan:User", userid)
Reply_Status(msg,userid,"reply","• تم الغاء حظره عام من المجموعات")  
return false
end

if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevitR(msg) then
function Function_itR(extra, result, success)
database:sadd(bot_id.."itR:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","• تم ترقيته مطور في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_itR, nil)
return false 
end
if text and text:match("^اضف مطور @(.*)$") and DevitR(msg) then
...
database:sadd(bot_id.."itR:Sudo:User", result.id_)
...
if text and text:match("^اضف مطور (%d+)$") and DevitR(msg) then
local userid = text:match("^اضف مطور (%d+)$")
database:sadd(bot_id.."itR:Sudo:User", userid)
Reply_Status(msg,userid,"reply","• تم ترقيته مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevitR(msg) then
function Function_itR(extra, result, success)
database:srem(bot_id.."itR:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","• تم تنزيله من المطورين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_itR, nil)
return false 
end
if text and text:match("^حذف مطور @(.*)$") and DevitR(msg) then
local username = text:match("^حذف مطور @(.*)$")
function Function_itR(extra, result, success)
if result.id_ then
database:srem(bot_id.."itR:Sudo:User", result.id_)
...
if text and text:match("^حذف مطور (%d+)$") and DevitR(msg) then
local userid = text:match("^حذف مطور (%d+)$")
database:srem(bot_id.."itR:Sudo:User", userid)
...
function Function_itR(extra, result, success)
database:sadd(bot_id.."itR:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."itR:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."itR:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_itR(extra, result, success)
database:srem(bot_id.."itR:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
function Function_itR(extra, result, success)
if result.id_ then
database:srem(bot_id.."itR:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."itR:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_itR(extra, result, success)
database:sadd(bot_id.."itR:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."itR:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."itR:Constructor"..msg.chat_id_, userid)
...
function Function_itR(extra, result, success)
database:srem(bot_id.."itR:Constructor"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","• تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_itR, nil)
end
...
function Function_itR(extra, result, success)
if result.id_ then
database:srem(bot_id.."itR:Constructor"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","• تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"• لا يوجد حساب بهاذا المعرف")
end
...
database:srem(bot_id.."itR:Constructor"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","• تم تنزيله من المنشئين")  
end
...
function Function_itR(extra, result, success)
database:sadd(bot_id.."itR:Manager"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."itR:Manager"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."itR:Manager"..msg.chat_id_, userid)
...
function Function_itR(extra, result, success)
database:srem(bot_id.."itR:Manager"..msg.chat_id_, result.sender_user_id_)
...
function Function_itR(extra, result, success)
if result.id_ then
database:srem(bot_id.."itR:Manager"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."itR:Manager"..msg.chat_id_, userid)
...
function Function_itR(extra, result, success)
database:sadd(bot_id.."itR:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."itR:Mod:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."itR:Mod:User"..msg.chat_id_, userid)
...
function Function_itR(extra, result, success)
database:srem(bot_id.."itR:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_itR(extra, result, success)
if result.id_ then
database:srem(bot_id.."itR:Mod:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."itR:Mod:User"..msg.chat_id_, userid)
...
function Function_itR(extra, result, success)
database:sadd(bot_id.."itR:Special:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."itR:Special:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."itR:Special:User"..msg.chat_id_, userid)
...
function Function_itR(extra, result, success)
database:srem(bot_id.."itR:Special:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_itR(extra, result, success)
if result.id_ then
database:srem(bot_id.."itR:Special:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."itR:Special:User"..msg.chat_id_, userid)
...
if database:sismember(bot_id.."itR:Coomds"..msg.chat_id_,RTPA) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local itRrt = database:get(bot_id.."itR:Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if itRrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n• العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "VuYuV")..")".."\n• تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."itR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."itR:Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif itRrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n• العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "VuYuV")..")".."\n• تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."itR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."itR:Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif itRrt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"\n• العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "VuYuV")..")".."\n• تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."itR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."itR:Manager"..msg.chat_id_,result.sender_user_id_)  
elseif itRrt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n• العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "VuYuV")..")".."\n• تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
database:srem(bot_id.."itR:Special:User"..msg.chat_id_,result.sender_user_id_)  
database:del(bot_id.."itR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif itRrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n• العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "VuYuV")..")".."\n• تم تنزيله من "..RTPA.." هنا\n")  
database:srem(bot_id.."itR:Mod:User"..msg.chat_id_,result.sender_user_id_) 
database:del(bot_id.."itR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
...
if database:sismember(bot_id.."itR:Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local itRrt = database:get(bot_id.."itR:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if itRrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n• العضو ↺ ["..result.title_.."](t.me/"..(text1[3] or "VuYuV")..")".."\n• تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."itR:Special:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."itR:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif itRrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n• العضو ↺ ["..result.title_.."](t.me/"..(text1[3] or "VuYuV")..")".."\n• تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."itR:Mod:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."itR:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
...
database:srem(bot_id.."itR:Special:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."itR:Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif itRrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n• العضو ↺ ["..result.title_.."](t.me/"..(text1[3] or "VuYuV")..")".."\n• تم تنريله من "..text1[2].." هنا")   
database:srem(bot_id.."itR:Mod:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."itR:Comd:New:rt:User:"..msg.chat_id_..result.id_)
...
database:sadd(bot_id.."itR:Ban:User"..msg.chat_id_, result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."itR:Ban:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."itR:Ban:User"..msg.chat_id_, userid)
...
database:srem(bot_id.."itR:Ban:User"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."itR:Ban:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."itR:Ban:User"..msg.chat_id_, userid)
...
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."itR:Muted:User"..msg.chat_id_, userid)
...
function Function_itR(extra, result, success)
database:srem(bot_id.."itR:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_itR(extra, result, success)
if result.id_ then
database:srem(bot_id.."itR:Muted:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."itR:Muted:User"..msg.chat_id_, userid)
...
database:set(bot_id..'itR:itR:lock:Fshar'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","• تم قفـل الفارسيه")  
end
if text and database:get(bot_id..'itR:lock:Fshar'..msg.chat_id_) and not Addictive(msg) then 
...
database:del(bot_id..'itR:itR:lock:Fshar'..msg.chat_id_) 
...
database:set(bot_id..'itR:lock:Fshar'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","• تم قفـل الفشار")  
end
if text and database:get(bot_id..'itR:itR:lock:Fshar'..msg.chat_id_) and not Addictive(msg) then 
...
database:del(bot_id..'itR:lock:Fshar'..msg.chat_id_) 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n• العضو ↺ ['..data.first_name_..'](t.me/'..(data.username_ or 'itR')..') '
...
if database:sismember(bot_id.."itR:Lock:pin",msg.chat_id_) and not Constructor(msg) then
...
database:set(bot_id.."itR:Pin:Id:Msg"..msg.chat_id_,msg.reply_to_message_id_)
...
database:del(bot_id.."itR:Pin:Id:Msg"..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"• انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"• ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
...
database:hset(bot_id.."itR:flooding:settings:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."itR:flooding:settings:"..msg.chat_id_ ,"floodtime" ,Num) 
...
database:sadd(bot_id.."itR:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."itR:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "• تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."itR:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."itR:allM"..msg.chat_id_)
...
database:set(bot_id.."itR:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_,true) 
...
if Addictive(msg) then
database:setex(bot_id.."itR:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if Addictive(msg) then
database:setex(bot_id.."itR:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if database:get(bot_id.."itR:Get:Welcome:Group"..msg.chat_id_)   then 
Welcome = database:get(bot_id.."itR:Get:Welcome:Group"..msg.chat_id_)  
else 
...
database:set(bot_id.."itR:Chek:Welcome"..msg.chat_id_,true) 
...
database:del(bot_id.."itR:Chek:Welcome"..msg.chat_id_) 
...
if Addictive(msg) then
database:del(bot_id.."itR:Get:Welcome:Group"..msg.chat_id_) 
...
database:set(bot_id.."itR:Filter:msg",msg.chat_id_)
...
local listtext = database:smembers(bot_id.."itR:List:Filter:text"..msg.chat_id_)  
for k,v in pairs(listtext) do  
database:srem(bot_id.."itR:List:Filter:text"..msg.chat_id_,v)  
end  
local listAnimation = database:smembers(bot_id.."itR:List:Filter:Animation"..msg.chat_id_)  
for k,v in pairs(listAnimation) do  
database:srem(bot_id.."itR:List:Filter:Animation"..msg.chat_id_,v)  
end  
local listSticker = database:smembers(bot_id.."itR:List:Filter:Sticker"..msg.chat_id_)  
for k,v in pairs(listSticker) do  
database:srem(bot_id.."itR:List:Filter:Sticker"..msg.chat_id_,v)  
end  
local listPhoto = database:smembers(bot_id.."itR:List:Filter:Photo"..msg.chat_id_)  
for k,v in pairs(listPhoto) do  
database:srem(bot_id.."itR:List:Filter:Photo"..msg.chat_id_,v)  
end  
...
database:set(bot_id.."itR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."itR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"• تم منع الكلمه بنجاح")  
database:del(bot_id.."itR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."itR:List:Filter:text"..msg.chat_id_,text)  
return false 
end  
end
...
database:del(bot_id.."itR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."itR:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."itR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."itR:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."itR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."itR:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false 
end  
end
...
database:set(bot_id.."itR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false 
end
if text then 
local test = database:get(bot_id.."itR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_,"• تم الغاء منعها ")  
database:del(bot_id.."itR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."itR:List:Filter:text"..msg.chat_id_,text)  
return false
end  
end
if msg.content_.ID == 'MessageAnimation' then    
local onte = database:get(bot_id.."itR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if onte and onte == "reppp" then   
send(msg.chat_id_, msg.id_,"• تم الغاء منع المتحركه بنجاح ")  
database:del(bot_id.."itR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."itR:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessageSticker' then    
local Stic = database:get(bot_id.."itR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if Stic and Stic == "reppp" then   
send(msg.chat_id_, msg.id_,"• تم الغاء منع الملصق بنجاح ")  
database:del(bot_id.."itR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."itR:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessagePhoto' then    
local hoto = database:get(bot_id.."itR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if hoto and hoto == "reppp" then   
send(msg.chat_id_, msg.id_,"• تم الغاء منع الصوره بنجاح ")  
database:del(bot_id.."itR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."itR:List:Filter:Photo"..msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false
end  
end
...
if database:get(bot_id.."itR:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "• تم الغاء حفظ القوانين") 
database:del(bot_id.."itR:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."itR:Set:Rules:Group" .. msg.chat_id_,text) 
...
if Addictive(msg) then
database:setex(bot_id.."itR:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:del(bot_id.."itR:Set:Rules:Group"..msg.chat_id_) 
end
end
...
local Set_Rules = database:get(bot_id.."itR:Set:Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
local list = database:smembers(bot_id.."itR:List:Cmd:Group:New"..msg.chat_id_.."")
t = "• قائمه الاوامر المضافه  \n  ━═━═━═━\n"
for k,v in pairs(list) do
Cmds = database:get(bot_id.."itR:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..""..k.."- ("..v..") ~ {"..Cmds.."}\n"
else
t = t..""..k.."- ("..v..") \n"
...
local list = database:smembers(bot_id.."itR:List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."itR:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
database:del(bot_id.."itR:List:Cmd:Group:New"..msg.chat_id_)
end
send(msg.chat_id_, msg.id_,"• تم مسح جميع الاوامر التي تم اضافتها")  
end
end
if text == "ترتيب الاوامر" and Constructor(msg) then
database:set(bot_id.."itR:Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
database:sadd(bot_id.."itR:List:Cmd:Group:New"..msg.chat_id_,"ا")
database:set(bot_id.."itR:Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
database:sadd(bot_id.."itR:List:Cmd:Group:New"..msg.chat_id_,"م")
database:set(bot_id.."itR:Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
database:sadd(bot_id.."itR:List:Cmd:Group:New"..msg.chat_id_,"اد")
database:set(bot_id.."itR:Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
database:sadd(bot_id.."itR:List:Cmd:Group:New"..msg.chat_id_,"مد")
database:set(bot_id.."itR:Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
database:sadd(bot_id.."itR:List:Cmd:Group:New"..msg.chat_id_,"من")
database:set(bot_id.."itR:Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
database:sadd(bot_id.."itR:List:Cmd:Group:New"..msg.chat_id_,"اس")
database:set(bot_id.."itR:Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
database:sadd(bot_id.."itR:List:Cmd:Group:New"..msg.chat_id_,"تعط")
database:set(bot_id.."itR:Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
database:sadd(bot_id.."itR:List:Cmd:Group:New"..msg.chat_id_,"تفع")
...
database:set(bot_id.."itR:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
if Constructor(msg) then
database:set(bot_id.."itR:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
function Function_itR(extra, result, success)
database:sadd(bot_id.."itR:MN:TF"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."itR:MN:TF"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."itR:MN:TF"..msg.chat_id_, userid)
...
function Function_itR(extra, result, success)
database:srem(bot_id.."itR:MN:TF"..msg.chat_id_, result.sender_user_id_)
...
function Function_itR(extra, result, success)
if result.id_ then
database:srem(bot_id.."itR:MN:TF"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."itR:MN:TF"..msg.chat_id_, userid)
...
local list = database:smembers(bot_id.."itR:Coomds"..msg.chat_id_)
if #list == 0 then
...
for k,v in pairs(list) do
var = database:get(bot_id.."itR:Comd:New:rt:bot:"..v..msg.chat_id_)
if var then
t = t..""..k.."- "..v.." ~ ("..var..")\n"
else
t = t..""..k.."- "..v.."\n"
...
database:del(bot_id.."itR:MN:TF"..msg.chat_id_)
...
local list = database:smembers(bot_id.."itR:MN:TF"..msg.chat_id_)
t = "\n• قائمة المنظفين \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."itR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."itR:Coomds"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."itR:Comd:New:rt:bot:"..v..msg.chat_id_)
database:del(bot_id.."itR:Coomds"..msg.chat_id_)
end
...
database:set(bot_id.."itR:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
database:sadd(bot_id.."itR:Coomds"..msg.chat_id_,ComdNew)  
database:setex(bot_id.."itR:Comd:New"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
...
database:del(bot_id.."itR:Comd:New:rt:bot:"..ComdNew..msg.chat_id_)
send(msg.chat_id_, msg.id_, "• تم مسح الصلاحيه ") 
end
if database:get(bot_id.."itR:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,"• تم الغاء الامر ") 
database:del(bot_id.."itR:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = database:get(bot_id.."itR:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
database:set(bot_id.."itR:Comd:New:rt:bot:"..textn..msg.chat_id_,text)
...
database:set(bot_id.."itR:Sudo:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"• تم تغير رد المطور الى ↺ "..Teext)
end
if text and text:match("^تغير رد المنشئ الاساسي (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ الاساسي (.*)$") 
database:set(bot_id.."itR:BasicConstructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"• تم تغير رد المنشئ الاساسي الى ↺ "..Teext)
end
if text and text:match("^تغير رد المنشئ (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ (.*)$") 
database:set(bot_id.."itR:Constructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"• تم تغير رد المنشئ الى ↺ "..Teext)
end
if text and text:match("^تغير رد المدير (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المدير (.*)$") 
database:set(bot_id.."itR:Manager:Rd"..msg.chat_id_,Teext) 
send(msg.chat_id_, msg.id_,"• تم تغير رد المدير الى ↺ "..Teext)
end
if text and text:match("^تغير رد الادمن (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد الادمن (.*)$") 
database:set(bot_id.."itR:Mod:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"• تم تغير رد الادمن الى ↺ "..Teext)
end
if text and text:match("^تغير رد المميز (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المميز (.*)$") 
database:set(bot_id.."itR:Special:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"• تم تغير رد المميز الى ↺ "..Teext)
end
if text and text:match("^تغير رد العضو (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد العضو (.*)$") 
database:set(bot_id.."itR:Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"• تم تغير رد العضو الى ↺ "..Teext)
end


if text == ("مسح ردود المدير") and BasicConstructor(msg) then
local list = database:smembers(bot_id.."itR:List:Manager"..msg.chat_id_.."")
for k,v in pairs(list) do
database:del(bot_id.."itR:Add:Rd:Manager:Gif"..v..msg.chat_id_)   
database:del(bot_id.."itR:Add:Rd:Manager:Vico"..v..msg.chat_id_)   
database:del(bot_id.."itR:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
database:del(bot_id.."itR:Add:Rd:Manager:Text"..v..msg.chat_id_)   
database:del(bot_id.."itR:Add:Rd:Manager:Photo"..v..msg.chat_id_)
database:del(bot_id.."itR:Add:Rd:Manager:Video"..v..msg.chat_id_)
database:del(bot_id.."itR:Add:Rd:Manager:File"..v..msg.chat_id_)
database:del(bot_id.."itR:Add:Rd:Manager:Audio"..v..msg.chat_id_)
database:del(bot_id.."itR:List:Manager"..msg.chat_id_)
end
...
for k,v in pairs(list) do
if database:get(bot_id.."itR:Add:Rd:Manager:Gif"..v..msg.chat_id_) then
db = "متحركه 🎭"
elseif database:get(bot_id.."itR:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمه 📢"
elseif database:get(bot_id.."itR:Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = "ملصق•"
elseif database:get(bot_id.."itR:Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = "رساله ✉"
elseif database:get(bot_id.."itR:Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = "صوره•"
elseif database:get(bot_id.."itR:Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = "فيديو 📹"
elseif database:get(bot_id.."itR:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف•"
elseif database:get(bot_id.."itR:Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = "اغنيه 🎵"
end
text = text..""..k..">> ("..v..") ↺ {"..db.."}\n"
end
...
local test = database:get(bot_id.."itR:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if database:get(bot_id.."itR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."itR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."itR:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."itR:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."itR:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."itR:Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."itR:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."itR:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."itR:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."itR:Add:Rd:Manager:Photo"..test..msg.chat_id_, photo_in_group)  
end
...
database:set(bot_id.."itR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
...
database:set(bot_id.."itR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."itR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '• الان ارسل الرد الذي تريد اضافته \n• قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n• يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."itR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
database:set(bot_id.."itR:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:del(bot_id.."itR:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."itR:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."itR:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."itR:Add:Rd:Manager:Text"..text..msg.chat_id_)   
database:del(bot_id.."itR:Add:Rd:Manager:Photo"..text..msg.chat_id_)
database:del(bot_id.."itR:Add:Rd:Manager:Video"..text..msg.chat_id_)
database:del(bot_id.."itR:Add:Rd:Manager:File"..text..msg.chat_id_)
database:del(bot_id.."itR:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:sadd(bot_id.."itR:List:Manager"..msg.chat_id_.."", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."itR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
...
database:del(bot_id.."itR:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:del(bot_id.."itR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."itR:List:Manager"..msg.chat_id_.."", text)
return false
end
end
if text and not database:get(bot_id.."itR:Reply:Manager"..msg.chat_id_) then
if not database:sismember(bot_id..'itR:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."itR:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = database:get(bot_id.."itR:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = database:get(bot_id.."itR:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local Text = database:get(bot_id.."itR:Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = database:get(bot_id.."itR:Add:Rd:Manager:Photo"..text..msg.chat_id_)
local video = database:get(bot_id.."itR:Add:Rd:Manager:Video"..text..msg.chat_id_)
local document = database:get(bot_id.."itR:Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = database:get(bot_id.."itR:Add:Rd:Manager:Audio"..text..msg.chat_id_)
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsg = database:get(bot_id..'itR:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'itR:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
send(msg.chat_id_, msg.id_,'['..Text..']')
database:sadd(bot_id.."itR:Spam:Group"..msg.sender_user_id_,text) 
end,nil)
end
if stekr then 
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and DevitR(msg) then 
local list = database:smembers(bot_id.."itR:List:Rd:Sudo")
for k,v in pairs(list) do
database:del(bot_id.."itR:Add:Rd:Sudo:Gif"..v)   
database:del(bot_id.."itR:Add:Rd:Sudo:vico"..v)   
database:del(bot_id.."itR:Add:Rd:Sudo:stekr"..v)     
database:del(bot_id.."itR:Add:Rd:Sudo:Text"..v)   
database:del(bot_id.."itR:Add:Rd:Sudo:Photo"..v)
database:del(bot_id.."itR:Add:Rd:Sudo:Video"..v)
database:del(bot_id.."itR:Add:Rd:Sudo:File"..v)
database:del(bot_id.."itR:Add:Rd:Sudo:Audio"..v)
database:del(bot_id.."itR:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"• تم مسح ردود المطور")
end
if text == ("ردود المطور") and DevitR(msg) then 
local list = database:smembers(bot_id.."itR:List:Rd:Sudo")
text = "\n• قائمة ردود المطور \n  ━═━═━═━\n"
for k,v in pairs(list) do
if database:get(bot_id.."itR:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif database:get(bot_id.."itR:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif database:get(bot_id.."itR:Add:Rd:Sudo:stekr"..v) then
db = "ملصق•"
elseif database:get(bot_id.."itR:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif database:get(bot_id.."itR:Add:Rd:Sudo:Photo"..v) then
db = "صوره•"
elseif database:get(bot_id.."itR:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif database:get(bot_id.."itR:Add:Rd:Sudo:File"..v) then
db = "ملف•"
elseif database:get(bot_id.."itR:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
end
text = text..""..k.." >> ("..v..") ↺ {"..db.."}\n"
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = database:get(bot_id.."itR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."itR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."itR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."itR:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."itR:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."itR:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."itR:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."itR:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."itR:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."itR:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
database:set(bot_id.."itR:Add:Rd:Sudo:Photo"..test, photo_in_group)  
end
send(msg.chat_id_, msg.id_,"• تم حفظ الرد بنجاح")
return false  
end  
...
if text == "اضف رد للكل" and DevitR(msg) then 
send(msg.chat_id_, msg.id_,"• ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."itR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevitR(msg) then 
send(msg.chat_id_, msg.id_,"• ارسل الكلمه التري تريد حذفها")
database:set(bot_id.."itR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."itR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '• الان ارسل الرد الذي تريد اضافته \n• قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n• يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."itR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."itR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."itR:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."itR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"• تم ازالة الرد من قائمه ردود المطور")
list = {"Add:Rd:Sudo:Audio","Add:Rd:Sudo:File","Add:Rd:Sudo:Video","Add:Rd:Sudo:Photo","Add:Rd:Sudo:Text","Add:Rd:Sudo:stekr","Add:Rd:Sudo:vico","Add:Rd:Sudo:Gif"}
for k,v in pairs(list) do
database:del(bot_id..'itR:'..v..text)
end
database:del(bot_id.."itR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."itR:List:Rd:Sudo", text)
return false
end
end

if text and not database:get(bot_id.."itR:Reply:Sudo"..msg.chat_id_) then
if not database:sismember(bot_id..'itR:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."itR:Add:Rd:Sudo:Gif"..text)   
local veico = database:get(bot_id.."itR:Add:Rd:Sudo:vico"..text)   
local stekr = database:get(bot_id.."itR:Add:Rd:Sudo:stekr"..text)     
local Text = database:get(bot_id.."itR:Add:Rd:Sudo:Text"..text)   
local photo = database:get(bot_id.."itR:Add:Rd:Sudo:Photo"..text)
local video = database:get(bot_id.."itR:Add:Rd:Sudo:Video"..text)
local document = database:get(bot_id.."itR:Add:Rd:Sudo:File"..text)
local audio = database:get(bot_id.."itR:Add:Rd:Sudo:Audio"..text)
...
if database:sismember(bot_id.."itR:Sudo:User",result.id_) then
dev = "المطور ،" else dev = "" end
if database:sismember(bot_id.."itR:Basic:Constructor"..msg.chat_id_, result.id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."itR:Constructor"..msg.chat_id_, result.id_) then
cr = "منشئ ،" else cr = "" end
if database:sismember(bot_id.."itR:Manager"..msg.chat_id_, result.id_) then
own = "مدير ،" else own = "" end
if database:sismember(bot_id.."itR:Mod:User"..msg.chat_id_, result.id_) then
mod = "ادمن ،" else mod = "" end
if database:sismember(bot_id.."itR:Special:User"..msg.chat_id_, result.id_) then
vip = "مميز ،" else vip = ""
end
...
database:srem(bot_id.."itR:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."itR:Special:User"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."itR:Sudo:User",msg.sender_user_id_) then
database:srem(bot_id.."itR:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."itR:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."itR:Manager"..msg.chat_id_, result.id_)
database:srem(bot_id.."itR:Constructor"..msg.chat_id_, result.id_)
database:srem(bot_id.."itR:Basic:Constructor"..msg.chat_id_,result.id_)
elseif database:sismember(bot_id.."itR:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."itR:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."itR:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."itR:Manager"..msg.chat_id_, result.id_)
database:srem(bot_id.."itR:Constructor"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."itR:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."itR:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."itR:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."itR:Manager"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."itR:Manager"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."itR:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."itR:Special:User"..msg.chat_id_, result.id_)
end
else
...
if database:sismember(bot_id.."itR:Sudo:User",result.sender_user_id_) then
dev = "المطور ،" else dev = "" end
if database:sismember(bot_id.."itR:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."itR:Constructor"..msg.chat_id_, result.sender_user_id_) then
cr = "منشئ ،" else cr = "" end
if database:sismember(bot_id.."itR:Manager"..msg.chat_id_, result.sender_user_id_) then
own = "مدير ،" else own = "" end
if database:sismember(bot_id.."itR:Mod:User"..msg.chat_id_, result.sender_user_id_) then
mod = "ادمن ،" else mod = "" end
if database:sismember(bot_id.."itR:Special:User"..msg.chat_id_, result.sender_user_id_) then
vip = "مميز ،" else vip = ""
end
...
for k, v in pairs(list) do
x = x + 1
if database:get(bot_id.."itR:User:Name"..v.user_id_) then
t = t.."•┆"..x.."︙[@"..database:get(bot_id.."itR:User:Name"..v.user_id_).."]\n"
end
end
send(msg.chat_id_,msg.id_,t)
end,nil)
...
if not database:get(bot_id.."itR:Kick:Me"..msg.chat_id_) then
...
database:del(bot_id.."itR:Kick:Me"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,Text) 
end
...
database:set(bot_id.."itR:Kick:Me"..msg.chat_id_,true)  
Text = "\n• تم تعطيل امر اطردني"
send(msg.chat_id_, msg.id_,Text) 
end
...
function Function_itR(extra, result, success)
if result.id_ then
if database:sismember(bot_id.."itR:Muted:User"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."itR:Ban:User"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."itR:GBan:User",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
function Function_itR(extra, result, success)
if database:sismember(bot_id.."itR:Muted:User"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."itR:Ban:User"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."itR:GBan:User",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
database:sadd(bot_id.."itR:Mod:User"..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
database:srem(bot_id.."itR:Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
database:srem(bot_id.."itR:Mod:User"..msg.chat_id_, admins[i].user_id_)
...
database:sadd(bot_id.."itR:Basic:Constructor"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
end

if text == "غادر" then 
if DevBot(msg) and not database:get(bot_id.."itR:Left:Bot"..msg.chat_id_) then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,"• تم مغادرة المجموعه") 
database:srem(bot_id.."itR:Chek:Groups",msg.chat_id_)  
end
return false  
end
...
database:srem(bot_id.."itR:Chek:Groups",GP_ID[2])  
return false 
end
end
if text == "تفعيل المغادره" and DevitR(msg) then   
database:del(bot_id.."itR:Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"• تم تفعيل مغادرة البوت") 
return false 
end
if text == "تعطيل المغادره" and DevitR(msg) then  
database:set(bot_id.."itR:Left:Bot"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "• تم تعطيل مغادرة البوت") 
return false 
end
if text == (database:get(bot_id.."itR:Name:Bot") or "رايلون") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."itR:Name:Bot") or "رايلون")
local namebot = {
...
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:itR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\nارسل لي الكلمه الان ')
database:set(bot_id.."botss:itR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:itR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:itR:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:itR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:itR:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:itR:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:itR:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:itR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:itR:List:Rd:Sudo", text)
return false
end
end
if text == ("مسح الردود المتعدده") and DevitR(msg) then
 
local list = database:smembers(bot_id.."botss:itR:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:itR:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:itR:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:itR:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:itR:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"تم حذف ردود المتعدده")
end
if text == ("الردود المتعدده") and DevitR(msg) then
...
if text == "اضف رد متعدد" and DevitR(msg) then
 
database:set(bot_id.."botss:itR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"ارسل الرد الذي اريد اضافته")
end
if text == "حذف رد متعدد" and DevitR(msg) then
 
database:set(bot_id.."botss:itR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:itR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:itR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:itR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:itR:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:itR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:itR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:itR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:itR:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:itR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:itR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:itR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:itR:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:itR:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:itR:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:itR:Add:Rd:Sudo:Text2"..text)   
...
if DevitR(msg) then
database:setex(bot_id.."itR:Set:Name:Bot"..msg.sender_user_id_,300,true) 
...
if database:get(bot_id.."itR:Status:Bc") and not DevitR(msg) then 
send(msg.chat_id_, msg.id_,"• الاذاعه معطله من قبل المطور الاساسي")
return false
end
database:setex(bot_id.."itR:itR:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."itR:itR:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"• ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n• للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."itR:itR:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"• ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n• للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."itR:itR:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."itR:itR:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"• ارسل لي التوجيه الان") 
return false
end 

if text == "تفعيل الاذاعه" and DevitR(msg) then  
database:del(bot_id.."itR:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n• تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and DevitR(msg) then  
database:set(bot_id.."itR:Status:Bc",true) 
send(msg.chat_id_, msg.id_,"\n• تم تعطيل الاذاعه") 
return false
end 

if text == "الاعدادات" and Addictive(msg) then    
if database:get(bot_id.."itR:lockpin"..msg.chat_id_) then    
lock_pin = "✓"
else 
lock_pin = "✘"    
end
if database:get(bot_id.."itR:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✘"    
end
if database:get(bot_id.."itR:Lock:text"..msg.chat_id_) then    
lock_text = "✓"
else 
lock_text = "✘"    
end
...
if database:get(bot_id.."itR:Lock:edit"..msg.chat_id_) then    
lock_edit = "✓"
else 
lock_edit = "✘"    
end
...
if database:hget(bot_id.."itR:flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
flood = "بالطرد"     
elseif database:hget(bot_id.."itR:flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
flood = "بالتقيد"     
elseif database:hget(bot_id.."itR:flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
flood = "بالكتم"           
elseif database:hget(bot_id.."itR:flooding:settings:"..msg.chat_id_,"flood") == "del" then     
flood = "بالمسح"           
else     
flood = "✘"     
end
...
if database:get(bot_id.."itR:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "✓"
elseif database:get(bot_id.."itR:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "بالتقيد"    
elseif database:get(bot_id.."itR:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "بالكتم"    
elseif database:get(bot_id.."itR:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "بالطرد"    
else
lock_links = "✘"    
end
if database:get(bot_id.."itR:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "✓"
elseif database:get(bot_id.."itR:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "بالتقيد"    
elseif database:get(bot_id.."itR:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "بالكتم"   
elseif database:get(bot_id.."itR:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "بالطرد"    
else
lock_cmds = "✘"    
end
if database:get(bot_id.."itR:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "✓"
elseif database:get(bot_id.."itR:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "بالتقيد"    
elseif database:get(bot_id.."itR:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "بالكتم"    
elseif database:get(bot_id.."itR:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "بالطرد"    
else
lock_user = "✘"    
end
if database:get(bot_id.."itR:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "✓"
elseif database:get(bot_id.."itR:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "بالتقيد"    
elseif database:get(bot_id.."itR:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "بالكتم"    
elseif database:get(bot_id.."itR:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "بالطرد"    
else
lock_hash = "✘"    
end
...
if database:get(bot_id.."itR:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "✓"
elseif database:get(bot_id.."itR:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif database:get(bot_id.."itR:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "✘"    
end
...
if database:get(bot_id.."itR:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "✓"
elseif database:get(bot_id.."itR:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "بالتقيد"    
elseif database:get(bot_id.."itR:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "بالكتم"    
elseif database:get(bot_id.."itR:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "بالطرد"    
else
lock_spam = "✘"    
end        
if not database:get(bot_id.."itR:Reply:Manager"..msg.chat_id_) then
rdmder = "✓"
else
rdmder = "✘"
end
if not database:get(bot_id.."itR:Reply:Sudo"..msg.chat_id_) then
rdsudo = "✓"
else
rdsudo = "✘"
end
if not database:get(bot_id.."itR:Lock:ID:Bot"..msg.chat_id_)  then
idgp = "✓"
else
idgp = "✘"
end
if not database:get(bot_id.."itR:Lock:ID:Bot:Photo"..msg.chat_id_) then
idph = "✓"
else
idph = "✘"
end
if not database:get(bot_id.."itR:Lock:kick"..msg.chat_id_)  then
setadd = "✓"
else
setadd = "✘"
end
if not database:get(bot_id.."itR:Lock:Add:Bot"..msg.chat_id_)  then
banm = "✓"
else
banm = "✘"
end
...
Num_Flood = database:hget(bot_id.."itR:flooding:settings:"..msg.chat_id_,"floodmax") or 0
local text = 
"*\n• ااعدادات المجموعه "..
"\n  ━═━═━═━"..
"\n• علامة ال {✓} تعني مفعل"..
...
database:set(bot_id.."itR:Fun_Bots"..msg.chat_id_,"true")
end
...
database:del(bot_id.."itR:Fun_Bots"..msg.chat_id_)
end
...
database:del(bot_id..'itR:Lock:ID:Bot'..msg.chat_id_) 
...
database:set(bot_id..'itR:Lock:ID:Bot'..msg.chat_id_,true) 
...
database:del(bot_id..'itR:Lock:ID:Bot:Photo'..msg.chat_id_) 
...
database:set(bot_id..'itR:Lock:ID:Bot:Photo'..msg.chat_id_,true) 
...
database:setex(bot_id.."itR:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
local Text= [[
• ارسل الان النص
• يمكنك اضافه :
- `#username` > اسم المستخدم
...
database:set(bot_id.."itR:Klesh:Id:Bot"..msg.chat_id_,Text_Rand)
send(msg.chat_id_, msg.id_,'• تم تغير الايدي ارسل ايدي لرؤيته')
end
if text == 'حذف الايدي' or text == 'مسح الايدي' then
if Owner(msg) then
database:del(bot_id.."itR:Klesh:Id:Bot"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '• تم ازالة كليشة الايدي ')
end
return false  
end 

if database:get(bot_id.."itR:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"• تم الغاء تعين الايدي") 
database:del(bot_id.."itR:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."itR:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
database:set(bot_id.."itR:Klesh:Id:Bot"..msg.chat_id_,text:match("(.*)"))
send(msg.chat_id_, msg.id_,'• تم تعين الايدي')    
end

if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'itR:Lock:ID:Bot'..msg.chat_id_) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local Add_Mem = database:get(bot_id.."itR:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local get_id = database:get(bot_id.."itR:Klesh:Id:Bot"..msg.chat_id_)
if not database:get(bot_id..'itR:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
if not database:get(bot_id..'itR:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'itR:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
local Id = data.id_
local NumMsg = database:get(bot_id..'itR:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'itR:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id.."Tshak:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."itR:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
...
if text and text:match("^ايدي @(.*)$")  and not database:get(bot_id..'itR:Lock:ID:Bot'..msg.chat_id_) then
...
if text == 'رسائلي' then
local nummsg = database:get(bot_id..'itR:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 1
local Text = '• عدد رسائلك هنا *~ '..nummsg..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح رسائلي' then
database:del(bot_id..'itR:messageUser'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '• تم مسح جميع رسائلك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'سحكاتي' or text == 'تعديلاتي' then
local edit = database:get(bot_id..'itR:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Text = '• عدد التعديلات هنا *~ '..edit..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
database:del(bot_id..'itR:message_edit'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '• تم مسح جميع تعديلاتك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'جهاتي' then
local addmem = database:get(bot_id.."itR:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
local Text = '• عدد جهاتك المضافه هنا *~ '..addmem..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح جهاتي' then
database:del(bot_id..'itR:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
...
database:incrby(bot_id.."itR:messageUser"..msg.chat_id_..":"..msg.sender_user_id_,NUMNKO)  
...
database:incrby(bot_id.."itR:messageUser"..msg.chat_id_..":"..iduserr,numadded)  
...
database:incrby(bot_id.."itR:messageUser"..msg.chat_id_..":"..result.sender_user_id_,Num)  
...
if text == "تنظيف المشتركين" and DevitR(msg) then
local pv = database:smembers(bot_id..'itR:UsersBot')  
local sendok = 0
for i = 1, #pv do
...
database:srem(bot_id..'itR:UsersBot',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
if text == "تنظيف الكروبات" and DevitR(msg) then
local group = database:smembers(bot_id..'itR:Chek:Groups')  
local w = 0
local q = 0
for i = 1, #group do
...
database:srem(bot_id..'itR:Chek:Groups',group[i])  
w = w + 1
end
...
if text == ("تحديث السورس") and DevitR(msg) then  
send(msg.chat_id_,msg.id_,'• تم التحديث')
os.execute('rm -rf itR.lua')
os.execute('rm -rf start.lua')
os.execute('wget https://raw.githubusercontent.com/RyllonTeam/itR/master/itR.lua')
os.execute('wget https://raw.githubusercontent.com/RyllonTeam/itR/master/start.lua')
dofile('itR.lua')  
return false
end
if text == "راسلني" then
...
database:set(bot_id.."itR:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Owner(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الزخرفه')
database:set(bot_id.."itR:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."itR:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."itR:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Owner(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الابراج')
database:set(bot_id.."itR:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.."itR:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."itR:age_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل حساب العمر" and Owner(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل حساب العمر')
database:set(bot_id.."itR:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.."itR:age_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."itR:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Owner(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الانستا')
database:set(bot_id.."itR:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."itR:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."itR:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Owner(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الافلام')
database:set(bot_id.."itR:movie_bot"..msg.chat_id_,"open")
end

if text and text:match("^فلم (.*)$") and database:get(bot_id.."itR:movie_bot"..msg.chat_id_) == "open" then
...
if (msg.content_.sticker_)  and msg.reply_to_message_id_ == 0 and database:get(bot_id.."itR:Lock:Xn"..msg.chat_id_)=="del" then      
...
if (msg.content_.photo_) and msg.reply_to_message_id_ == 0 and database:get(bot_id.."itR:Lock:Xn"..msg.chat_id_)=="del" then
photo_id = msg.content_.photo_.sizes_[1].photo_.persistent_id_  
Srrt = https.request('https://itR-source.tk/VuYuV/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
if text == 'تفعيل البوت الخدمي' and DevitR(msg) then  
database:del(bot_id..'itR:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'• تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت الخدمي' and DevitR(msg) then  
database:set(bot_id..'itR:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'• تم تعطيل البوت الخدمي') 
end
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevitR(msg) then
local Num = text:match("تعين عدد الاعضاء (%d+)$") 
database:set(bot_id..'itR:Num:Add:Bot',Num) 
send(msg.chat_id_, msg.id_,'• تم وضع عدد الاعضاء *~'..Num..'* عضو')
end
if text =='الاحصائيات' and DevBot(msg) then
local Groups = database:scard(bot_id..'itR:Chek:Groups')  
local Users = database:scard(bot_id..'itR:UsersBot')  
send(msg.chat_id_, msg.id_,'• احصائيات البوت \n\n• عدد المجموعات *~ '..Groups..'\n• عدد المشتركين ~ '..Users..'*')
end
if text == 'جلب نسخه احتياطيه' and DevitR(msg) then
local list = database:smembers(bot_id..'itR:Chek:Groups')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'itR Chat'
ASAS = database:smembers(bot_id.."itR:Basic:Constructor"..v)
MNSH = database:smembers(bot_id.."itR:Constructor"..v)
MDER = database:smembers(bot_id.."itR:Manager"..v)
MOD = database:smembers(bot_id.."itR:Mod:User"..v)
link = database:get(bot_id.."itR:Link_Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"itR":"'..NAME..'",'
else
t = t..',"'..v..'":{"itR":"'..NAME..'",'
...
local Text_Dev = database:get(bot_id..'itR:Text_Dev')
if Text_Dev then 
...
if text == 'الملفات' and DevitR(msg) then
t = '• جميع الملفات : \n  ━═━═━═━\n'
i = 0
for v in io.popen('ls itR_Files'):lines() do
if v:match(".lua$") then
...
if DevitR(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/VuYuV/files_itR/master/getfile.json")
if res == 200 then
...
local Check_File_is_Found = io.open("itR_Files/"..name,"r")
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevitR(msg) then
local name_t = {string.match(text, "^(تعطيل ملف) (.*)(.lua)$")}
local file = name_t[2]..'.lua'
local file_bot = io.open("itR_Files/"..file,"r")
if file_bot then
io.close(file_bot)
...
local json_file, res = https.request("https://raw.githubusercontent.com/VuYuV/files_itR/master/files_itR/"..file)
if res == 200 then
os.execute("rm -fr itR_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('itR.lua')  
else
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevitR(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/VuYuV/files_itR/master/files_itR/"..file)
if res == 200 then
local chek = io.open("itR_Files/"..file,'w+')
...
if text == "مسح جميع الملفات" and DevitR(msg) then
os.execute("rm -fr itR_Files/*")
send(msg.chat_id_,msg.id_,"• تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and DevitR(msg) then
local Users = database:smembers('itR:'..bot_id.."userss")
local Groups = database:smembers('itR:'..bot_id..'groups') 
for i = 1, #Groups do
database:sadd(bot_id..'itR:Chek:Groups',Groups[i])  
end
for i = 1, #Users do
database:sadd(bot_id..'itR:UsersBot',Users[i])  
end
send(msg.chat_id_, msg.id_,'• تم نقل : '..#Groups..' كروب\n• تم نقل : '..#Users..' مشترك \n• من التحديث القديم الى التحديث الجديد')
end
if text == 'حذف كليشه المطور' and DevitR(msg) then
database:del(bot_id..'itR:Text_Dev')
send(msg.chat_id_, msg.id_,'• تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevitR(msg) then
database:set(bot_id..'itR:Set:Text_Dev'..msg.chat_id_,true)
send(msg.chat_id_,msg.id_,'• ارسل الكليشه الان')
return false
end
if text and database:get(bot_id..'itR:Set:Text_Dev'..msg.chat_id_) then
if text == 'الغاء' then 
database:del(bot_id..'itR:Set:Text_Dev'..msg.chat_id_)
send(msg.chat_id_,msg.id_,'• تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'itR:Text_Dev',text)
database:del(bot_id..'itR:Set:Text_Dev'..msg.chat_id_)
...
if text == 'رفع النسخه الاحتياطيه' and DevitR(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == "تحديث" and DevitR(msg) then
dofile("itR.lua")  
send(msg.chat_id_, msg.id_, "• تم التحديث")
end

if text == 'السورس' or text == 'سورس' or text == 'ياسورس' or text == 'يا سورس' then  
local url,res = https.request('https://evzxar.ml/itR.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.itR ~= true then
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'itR:Num:Add:Bot') or 0) and not DevitR(msg) then
send(msg.chat_id_, msg.id_,'• عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'itR:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'itR:Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'• المجموعه مفعله سابقا ')
else
Reply_Status(msg,result.id_,'reply_Add','• تم تفعيل المجموعه ~ '..chat.title_..'')
database:sadd(bot_id..'itR:Chek:Groups',msg.chat_id_)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if not database:sismember(bot_id..'itR:Chek:Groups',msg.chat_id_) then
...
if text == 'تفعيل' and not DevBot(msg) and not database:get(bot_id..'itR:Free:Add:Bots') then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Reply_Status(msg,result.id_,'reply_Add','• تم تفعيل المجموعه ~ '..chat.title_..'')
database:sadd(bot_id..'itR:Chek:Groups',msg.chat_id_)  
database:sadd(bot_id..'itR:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
if not database:get(bot_id..'itR:Start:Time'..msg.sender_user_id_) then
...
database:setex(bot_id..'itR:Start:Time'..msg.sender_user_id_,60,true)
return false
end
if text and text:match("^/start ph(.*)$") then
Sf = database:get(bot_id.."itR:Filter:msg")
local list = database:smembers(bot_id.."itR:List:Filter:Photo"..Sf)  
for k,v in pairs(list) do
if v then
inline = {
...
local list = database:smembers(bot_id.."itR:List:Filter:text"..sl)
...
local list = database:smembers(bot_id.."itR:List:Filter:Animation"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
local list = database:smembers(bot_id.."itR:List:Filter:Sticker"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
if not DevitR(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."itR:Filter"..msg.sender_user_id_) then
...
if DevitR(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text and text:match("^- تغير الاشتراك• .$") and DevitR(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '• حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^- تغير رساله الاشتراك• .$") and DevitR(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '• حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك• ." and DevitR(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "• تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^- تعين قناة الاشتراك• .$") and DevitR(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '• حسنآ ارسل لي معرف القناة')
return false  
end
if text == "- تفعيل الاشتراك الاجباري• ." and DevitR(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "- تعطيل الاشتراك الاجباري• ." and DevitR(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "• تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "- الاشتراك الاجباري• ." and DevitR(msg) then  
...
database:srem(bot_id..'itR:Chek:Groups','-100'..data.channel_.id_)  
end
end
...
database:set(bot_id.."itR:Lock:text"..data.chat_id_,true) 
...
inline = {
{{text = '• itR 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/VuYuV'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."itR:List:Filter:Animation"..idchci,animation)  
end
if DAata and DAata:match("^pito(.*)$") and Addictive(data) then  
local idchci = database:get(bot_id.."itR:Filter:msg")
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."itR:List:Filter:Photo"..idchci,photo)  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."itR:List:Filter:Sticker"..idchci,Sticker)  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listSticker = database:smembers(bot_id.."itR:List:Filter:Sticker"..delallSticker)  
for k,v in pairs(listSticker) do  
database:srem(bot_id.."itR:List:Filter:Sticker"..delallSticker,v)  
end  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listAnimation = database:smembers(bot_id.."itR:List:Filter:Animation"..delallmation)  
for k,v in pairs(listAnimation) do  
database:srem(bot_id.."itR:List:Filter:Animation"..delallmation,v)  
end  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listPhoto = database:smembers(bot_id.."itR:List:Filter:Photo"..delallph)  
for k,v in pairs(listPhoto) do  
database:srem(bot_id.."itR:List:Filter:Photo"..delallph,v)  
end  
end
end
...
if text and not database:sismember(bot_id..'itR:Spam:Group'..msg.sender_user_id_,text) then
database:del(bot_id..'itR:Spam:Group'..msg.sender_user_id_) 
end
------------------------------------------------------------------------
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:set(bot_id..'itR:User:Name'..msg.sender_user_id_,data.username_)
end;end,nil)   
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."itR:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = database:get(bot_id.."itR:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."itR:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."itR:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
database:del(bot_id.."itR:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
database:del(bot_id.."itR:Set:Cmd:Group:New"..msg.chat_id_)
database:srem(bot_id.."itR:List:Cmd:Group:New"..msg.chat_id_,text)
...
database:del(bot_id.."itR:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
------------------------------------------------------------------------
if data.message_.content_.text_ then
local NewCmmd = database:get(bot_id.."itR:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
local Name_Bot = (database:get(bot_id.."itR:Name:Bot") or "رايلون")
if not database:get(bot_id.."itR:Fun_Bots"..msg.chat_id_) then
...
------------------------------------------------------------------------
itR_Started_Bot(msg,data)
itR_Files(msg)
elseif (data.ID == "UpdateMessageEdited") then
local msg = data
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.message_id_)},function(extra, result, success)
database:incr(bot_id..'itR:message_edit'..result.chat_id_..result.sender_user_id_)
local Text = result.content_.text_
if database:get(bot_id.."itR:Lock:edit"..msg.chat_id_) and not Text and not BasicConstructor(result) then
local list = database:smembers(bot_id.."itR:Basic:Constructor"..msg.chat_id_)
t = "• المنشئين الاساسين تعالو مخرب \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."itR:User:Name" .. v)
...
if database:get(bot_id.."itR:Lock:Link"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(@)(.*)") then
if database:get(bot_id.."itR:Lock:User:Name"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)") then
if database:get(bot_id.."itR:Lock:hashtak"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end 
...
------------------------------------------------------------------------
if text and text:match("/") then
if database:get(bot_id.."itR:Lock:Cmd"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end 
...
------------------------------------------------------------------------
if text then
local itR_Msg = database:sismember(bot_id.."itR:List:Filter:text"..result.chat_id_,text) 
if itR_Msg then    
...
if msg.content_.ID == 'MessageAnimation' then    
local Animation_Msg = database:sismember(bot_id.."itR:List:Filter:Animation"..result.chat_id_,result.content_.animation_.animation_.persistent_id_) 
...
if msg.content_.ID == 'MessagePhoto' then    
local Photo_Msg = database:sismember(bot_id.."itR:List:Filter:Photo"..result.chat_id_,result.content_.photo_.sizes_[1].photo_.persistent_id_) 
if Photo_Msg then    
...
if msg.content_.ID == 'MessageSticker' then    
local Sticker_Msg = database:sismember(bot_id.."itR:List:Filter:Sticker"..result.chat_id_,result.content_.sticker_.sticker_.persistent_id_) 
if Sticker_Msg then    
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get(bot_id..'itR:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'itR:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'itR:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
database:srem(bot_id..'itR:Chek:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'itR:Chek:Groups',v)  
end
...
database:sadd(bot_id..'itR:Chek:Groups',v)  
end end,nil)
